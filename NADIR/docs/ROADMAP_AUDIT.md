...
| 30–32 GNSS/ILRS | foundation | bounded SP3 position, RINEX CLK satellite-clock, RINEX 3 observables, GPS broadcast ephemeris parsing/Kepler ECEF propagation, and ILRS CPF type-10 position-table ingestion are covered; SSR, other constellations, CRD and independent validation fixtures remain open. |
