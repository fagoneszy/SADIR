...
| 17–19 catalog/performance/SoA | foundation | aliases, deterministic SoA batches, reusable bounded SGP4 worker pool and snapshot buffer exist; a large-catalog benchmark and frame scheduler remain open. |
