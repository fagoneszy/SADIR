...
| 30–32 GNSS/ILRS | foundation | bounded SP3 position, RINEX CLK satellite-clock, RINEX 3 observables, and GPS broadcast ephemeris parsing/Kepler ECEF propagation are covered; SSR, other constellations, CPF/CRD and independent validation fixtures remain open. |
