...
| 42 spacecraft geometry | foundation | OBJ, ASCII/binary STL, and embedded-buffer GLB triangle mesh loaders are tested; scene provenance binding and wider glTF features remain open. |
