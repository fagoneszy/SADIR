...
| 17–19 catalog/performance/SoA | foundation | aliases, deterministic SoA batches, bounded parallel propagation and snapshot buffer exist; persistent worker pool and large-catalog benchmark remain open. |
