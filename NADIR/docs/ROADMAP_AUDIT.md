...
| 43–46 Gaia/4D/network/geospatial layers | foundation | bounded Gaia CSV position/photometry subset ingestion; catalog distribution, proper motion/parallax, 4D display and geospatial layers remain open. |
